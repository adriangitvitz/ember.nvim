...
" Comments are declared near the end of this file so they win Vim's
" priority ties against the operator and keyword matches. See the
...
" ---------------------------------------------------------------------------
" Reference capabilities — highlighted as types
" ---------------------------------------------------------------------------
...
" ---------------------------------------------------------------------------
" Standard-library namespaces (matched as identifiers immediately followed by .)
" ---------------------------------------------------------------------------
...
" ---------------------------------------------------------------------------
" Annotations (@doc("..."), @route("..."))
" ---------------------------------------------------------------------------
syntax match yoruAnnotation "\v\@\w+"

" ---------------------------------------------------------------------------
" Effect lists — highlight content inside `effect [...]`
" ---------------------------------------------------------------------------
...
" ---------------------------------------------------------------------------
" `fn <name>` — name highlighted as a function definition.
...
" against earlier-defined match items). The explicit `contains=` whitelist
" stops keywords/types/operators from rendering inside comment text.
" ---------------------------------------------------------------------------
...
" ---------------------------------------------------------------------------
" Highlight links — map syntax groups to standard highlight groups.
" ---------------------------------------------------------------------------
