...
function M.create()
  ...
  vim.api.nvim_set_hl(0, 'SlimlineLspReady', { fg = miasma_colors.sage_green, default = true })
  vim.api.nvim_set_hl(0, 'SlimlineLspLoading', { fg = miasma_colors.gold, default = true })
  vim.api.nvim_set_hl(0, 'SlimlineLspError', { fg = miasma_colors.coral, default = true })
  vim.api.nvim_set_hl(0, 'SlimlinePm', { fg = miasma_colors.muted_sage, default = true })
  local components = {}
